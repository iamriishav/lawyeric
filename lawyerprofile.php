...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($update) {
        ...
        $_SESSION['certificate'] = $new_data['certificate'];
...
<body>
    ...
    <section class="form_container">
        <div class="action_btn">
            <button id="btn1" onclick="window.location.href='http://localhost/lawyeric/lawyerdashboard'">Dashboard</button>
            <button id="btn2" onclick="window.location.href='http://localhost/lawyeric/changepassword'">Change Password</button>
        </div>
        <div class="form">
            <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" name="profile_form">
                ...
                <input type="text" name="certificate" value="<?php echo $_SESSION['certificate']; ?>">
